...
def display_odds(odds_data, sport_name):
    ...
    for game in odds_data:
        ...
        # Example model (can be replaced with your real one)
        game_info["Model Home %"] = 55  # placeholder
        game_info["Model Away %"] = 45  # placeholder
        game_info["Home Value"] = round(game_info["Model Home %"] - game_info["Home Implied %"], 1)
        game_info["Away Value"] = round(game_info["Model Away %"] - game_info["Away Implied %"], 1)
